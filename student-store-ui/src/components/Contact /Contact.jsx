      ...
      <div className="contact" id="Contact">
        <div className="content">
          ...
          <div className="summary">
            ...
            <div className="media">
              <img src={HappyPerson} alt="Happy Person at CodePath" />
            </div>
          </div>
        </div>
      </div>
